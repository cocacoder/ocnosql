...
import com.ailk.oci.ocnosql.common.rowkeygenerator.GenRKCallBackBJImpl;

public class GenRKCallBackBJImpl implements GenRKCallBack {
	static Log LOG = LogFactory.getLog(GenRKCallBackBJImpl.class);
...
//		lineBuf.append(arr[1]).append(arr[3]).append(arr[4]);
		...
		LOG.info(impl.callback("", passwd,null));
	}

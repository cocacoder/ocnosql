...
hbase_random_write = HBASE_HOME +  "/bin/hbase org.apache.hadoop.hbase.PerformanceEvaluation --rows=" + str(rows) + " --presplit=200  randomWrite " + str(clients)
...
hbase_sequential_write =  HBASE_HOME +  "/bin/hbase org.apache.hadoop.hbase.PerformanceEvaluation  --rows=" + str(rows) + " --presplit=200 sequentialWrite " + str(clients)

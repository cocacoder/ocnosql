 ...
 */
public class MutipleColumnReducer extends
    Reducer<ImmutableBytesWritable, Put, ImmutableBytesWritable, KeyValue> {
//	 private MD5RowKeyGenerator  rowkeyGenerator;
...
//    String newRowkey = (String)rowkeyGenerator.generate(new String(row.copyBytes()));

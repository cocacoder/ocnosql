...
public class MultipleHbasePutAutoTest {
	...
	public void put(String[] args) {
		...
		params.put(CommonConstants.SKIPBADLINE, "false");
		params.put(CommonConstants.BATCH_PUT, "true");
		params.put(CommonConstants.HBASE_MAXPUTNUM, fulshNum);
		params.put(CommonConstants.ROWKEY_GENERATOR, "");
		params.put(CommonConstants.ROWKEY_UNIQUE, "false");
		// params.put(CommonConstants.ROWKEY_EXPRESSION, "${HBASE_ROW_KEY}");
		params.put(CommonConstants.STORAGE_STRATEGY, "mutipleimporttsv"); // mutipleimporttsv
		System.out.println("params is " + params);
		HBasePut client = new HBasePut(tableName, params);
		// String filePath =
		// "C:\\Users\\liuxiang2\\Documents\\NetBeansProjects\\PythonProject\\src\\com\\ailk\\ocnosql\\autotest\\data\\splitad";
